...
module.exports = function (flowContext, payload) {
    ...
    params.push("min_date_created=" + new Date(Date.parse(payload.modifiedDateRange.startDateGMT) - 1).toISOString());
    params.push("max_date_created=" + new Date(Date.parse(payload.modifiedDateRange.endDateGMT) + 1).toISOString());
