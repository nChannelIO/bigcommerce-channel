...
module.exports = function (flowContext, payload) {
    ...
    params.push("date_modified:min=" + new Date(Date.parse(payload.createdDateRange.startDateGMT) - 1).toISOString());
    params.push("date_modified:max=" + new Date(Date.parse(payload.createdDateRange.endDateGMT) + 1).toISOString());
